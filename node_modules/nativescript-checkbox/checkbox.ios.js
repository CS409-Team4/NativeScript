...
var CheckBox = (function (_super) {
    ...
    Object.defineProperty(CheckBox.prototype, "onTintColor", {
        get: function () {
            return this.style.onTintColor;
        },
        set: function (color) {
            this.style.onTintColor = color;
    ...
    Object.defineProperty(CheckBox.prototype, "checkBoxBackgroundColor", {
        get: function () {
            return this.style.checkBoxBackgroundColor;
        },
        set: function (color) {
            this._iosCheckbox.backgroundColor = new color_1.Color(color).ios;
            this.style.checkBoxBackgroundColor = color;
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(CheckBox.prototype, "onCheckColor", {
        get: function () {
            return this.style.onCheckColor;
        },
        set: function (color) {
            this.style.onCheckColor = color;
